      ...
      <div className="container-premium py-8 pt-24">
        ...
        <div className="mt-8 mb-12 text-center">
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full glass glow-primary mb-6">
            ...
            <span className="text-sm font-bold gradient-text">استكشف جميع التصنيفات</span>
          </div>

          <h1 className="text-ultra-lg font-black gradient-text mb-4">{t("categories")}</h1>
          <p className="text-ultra-base text-muted-foreground max-w-3xl mx-auto text-balance leading-relaxed">
            اكتشف آلاف الشركات المصنفة حسب المجال والتخصص. من السيارات إلى العقارات، من التقنية إلى الخدمات - كل ما
            تحتاجه في مكان واحد
          </p>
        </div>
