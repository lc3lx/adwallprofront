  ...
  const socialLinks = [
    {
      name: "Facebook",
      icon: Facebook,
      href: "https://www.facebook.com/share/1a66tVz9jP/",
      color: "text-blue-600",
      bgColor: "bg-blue-600",
    },
    {
      name: "Instagram",
      icon: Instagram,
      href: "https://www.instagram.com/adwallpro?utm_source=qr&igsh=cmxqbnR1MmxxMTFq",
      color: "text-pink-600",
      bgColor: "bg-gradient-to-r from-purple-600 to-pink-600",
    },
    {
      name: "TikTok",
      icon: Instagram, // Replace with TikTok icon if available, else keep placeholder
      href: "https://www.tiktok.com/@adwall.pro?_t=ZS-900BMVZKa7U&_r=1",
      color: "text-black",
      bgColor: "bg-gradient-to-br from-gray-900 via-gray-800 to-white",
    },
    {
      name: "Email",
      icon: Mail,
      href: "mahmudadwallpro@gmail.com",
